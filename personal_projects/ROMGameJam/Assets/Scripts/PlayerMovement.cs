...
public class PlayerMovement : MonoBehaviour {
	...
	void Update () {
		...
		Vector3 velocity_x = new Vector3(0, Input.GetAxis("Horizontal") * maxSpeed * Time.deltaTime, 0);
        Vector3 velocity_z = new Vector3(0, Input.GetAxis("Vertical") * maxSpeed * Time.deltaTime, 0);
