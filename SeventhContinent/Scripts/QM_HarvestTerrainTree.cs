...
public class QM_HarvestTerrainTree : MonoBehaviour {
    ...
    void Start() {
        ...
        lastTerrain = null;
        rMgr = GameObject.FindGameObjectWithTag("TerrainManager").GetComponent<QM_ResourceManager>();
    ...
    void Update() {
        ...
        if (Input.GetMouseButtonUp(0)) {
            ...
            if (Physics.Raycast(ray, out hit, 500f)) {
                ...
                //Debug.Log("hit height: " + hit.point.y);

                if (hit.point.y - .2f > groundHeight) {
                    //Debug.Log("must be a tree there");
    ...
    private void HarvestWood() {
        ...
        Debug.Log("Harvesting! tree count: " + treeCount);
